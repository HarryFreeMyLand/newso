    ...
    public class VMAvatar : VMEntity
    {
        ...
        */
        ...
        public ulong BodyOutfit
        {
            ...
            {
                _BodyOutfit = value;
                Avatar.Body = FSO.Content.GameContent.Get.AvatarOutfits.Get(value);
        ...
        public ulong HeadOutfit
        {
            ...
            {
                _HeadOutfit = value;
                Avatar.Head = (_HeadOutfit == 0)?null:FSO.Content.GameContent.Get.AvatarOutfits.Get(value);
            }
            get
            {
                return _HeadOutfit;
        ...
        public void SetAvatarType(STR data) {
            ...
            switch (AvatarType)
            {
                case VMAvatarType.Adult:
                    Avatar = new SimAvatar(FSO.Content.GameContent.Get.AvatarSkeletons.Get("adult.skel"));
                ...
                case VMAvatarType.Cat:
                    var skel = FSO.Content.GameContent.Get.AvatarSkeletons.Get("cat.skel");
                ...
                case VMAvatarType.Dog:
                    Avatar = new SimAvatar(FSO.Content.GameContent.Get.AvatarSkeletons.Get("dog.skel"));
        ...
        public override Texture2D GetIcon(GraphicsDevice gd, int store)
        {
            ...
            return FSO.Content.GameContent.Get.AvatarThumbnails.Get(Appearance.ThumbnailTypeID, Appearance.ThumbnailFileID);
        }
