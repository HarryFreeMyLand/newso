    ...
    public class UINeighborhoodSelectionPanel : UIContainer
    {
        ...
        public void PopulateScreen(ushort mode)
        {
            ...
            if (config.Music != null)
                HITVM.Get.PlaySoundEvent(config.Music);
