...
namespace FSO.Client
{
    ...
    public class TSOGame : FSO.Common.Rendering.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            FSO.Content.GameContent.Init(GlobalSettings.Default.StartupPath, GraphicsDevice);
            base.Initialize();
            ...
            if (!GameFacade.Linux) GameFacade.Cursor.Init(FSO.Content.GameContent.Get.GetPath(""));
