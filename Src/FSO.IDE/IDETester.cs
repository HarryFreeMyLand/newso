...
namespace FSO.IDE
{
    public class IDETester : IDEInjector
    {
        ...
        public void StartIDE(VM vm)
        {
            ...
            EditorScope.Behaviour = new Files.Formats.IFF.IffFile(Content.GameContent.Get.GetPath("objectdata/globals/behavior.iff"));
            EditorScope.Globals = FSO.Content.GameContent.Get.WorldObjectGlobals.Get("global");
