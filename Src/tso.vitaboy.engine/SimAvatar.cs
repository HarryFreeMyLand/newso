    ...
    public class SimAvatar : Avatar
    {
        ...
        private void ReloadHandgroup()
        {
            ...
            if (m_Handgroup != null)
            {
                ...
                var Handgroup = FSO.Content.GameContent.Get.AvatarHandgroups.Get(HandgroupID.TypeID, HandgroupID.FileID);
                ...
                Appearance LeftApr = FSO.Content.GameContent.Get.AvatarAppearances.Get(LeftID);
                Appearance RightApr = FSO.Content.GameContent.Get.AvatarAppearances.Get(RightID);
